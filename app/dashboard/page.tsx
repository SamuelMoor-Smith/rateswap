  ...
  return (
    <div className="prose prose-sm prose-invert max-w-none">
      ...
      <div className="flex gap-2">
        <ExternalLink href="https://nextjs.org/docs/app/building-your-application/routing/borrow">
          Docs
        </ExternalLink>
        <ExternalLink href="https://github.com/vercel/app-playground/tree/main/app/borrow">
          Code
        </ExternalLink>
      </div>
    </div>
